...
-- Design Ports Information
-- dout[0]	=>  Location: PIN_A12,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 8mA
-- dout[1]	=>  Location: PIN_A13,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 8mA
-- dout[2]	=>  Location: PIN_A14,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 8mA
-- dout[3]	=>  Location: PIN_A15,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 8mA
...
-- Equation(s):
-- \Equal0~2_combout\ = (div_counter(1) & (div_counter(4) & (div_counter(3) & div_counter(2))))
...
-- Equation(s):
-- \Equal0~5_combout\ = (div_counter(17) & (!div_counter(16) & (div_counter(19) & !div_counter(18))))
...
-- Equation(s):
-- \Equal0~6_combout\ = (div_counter(22) & (div_counter(21) & (div_counter(20) & div_counter(23))))
...
-- Equation(s):
-- \Equal0~7_combout\ = (!div_counter(24) & (\Equal0~5_combout\ & (div_counter(25) & \Equal0~6_combout\)))
...
-- Equation(s):
-- \count[0]~1_combout\ = ((count(2)) # ((count(1)) # (!count(3)))) # (!count(0))
