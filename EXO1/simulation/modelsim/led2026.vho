...
-- Design Ports Information
-- dout[0]	=>  Location: PIN_N2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- dout[1]	=>  Location: PIN_N1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- dout[2]	=>  Location: PIN_K5,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \count~1_combout\ = (!\rst~input_o\ & (count(1) $ (count(0))))
...
-- Equation(s):
-- \count~4_combout\ = (!\rst~input_o\ & (count(3) $ (((count(2) & \Add0~0_combout\)))))
...
-- Equation(s):
-- \count[0]~2_combout\ = (((!count(0)) # (!count(1))) # (!count(2))) # (!count(3))
...
-- Equation(s):
-- \count~3_combout\ = (!\rst~input_o\ & (\count[0]~2_combout\ & (\Add0~0_combout\ $ (count(2)))))
