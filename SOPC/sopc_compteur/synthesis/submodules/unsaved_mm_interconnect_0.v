...
module unsaved_mm_interconnect_0 (
		...
		input  wire        pwm_0_reset_reset_bridge_in_reset_reset,        //        pwm_0_reset_reset_bridge_in_reset.reset
	...
	wire   [6:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> pwm_0_avalon_slave_0_agent:cp_channel
	...
	wire         cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> BOUTONS_s1_agent:cp_valid
	wire  [92:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> BOUTONS_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // BOUTONS_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [6:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> BOUTONS_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> BOUTONS_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> BOUTONS_s1_agent:cp_endofpacket
	...
	wire         boutons_s1_agent_rp_valid;                                                          // BOUTONS_s1_agent:rp_valid -> router_007:sink_valid
	wire  [92:0] boutons_s1_agent_rp_data;                                                           // BOUTONS_s1_agent:rp_data -> router_007:sink_data
	wire         boutons_s1_agent_rp_ready;                                                          // router_007:sink_ready -> BOUTONS_s1_agent:rp_ready
	wire         boutons_s1_agent_rp_startofpacket;                                                  // BOUTONS_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         boutons_s1_agent_rp_endofpacket;                                                    // BOUTONS_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         boutons_s1_agent_rdata_fifo_src_valid;                                              // BOUTONS_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] boutons_s1_agent_rdata_fifo_src_data;                                               // BOUTONS_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         boutons_s1_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_005:in_0_ready -> BOUTONS_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> BOUTONS_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> BOUTONS_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                                  // BOUTONS_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> BOUTONS_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                               //                      clk.clk
		.reset                  (pwm_0_reset_reset_bridge_in_reset_reset),     //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                         //             clk.clk
		.reset                   (pwm_0_reset_reset_bridge_in_reset_reset),               //       clk_reset.reset
	...
	unsaved_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                   // in_clk_0.clk
		.in_rst_0_reset (pwm_0_reset_reset_bridge_in_reset_reset),         // in_rst_0.reset
