...
-- Design Ports Information
-- dout[0]	=>  Location: PIN_C6,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 8mA
-- dout[1]	=>  Location: PIN_F8,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 8mA
-- dout[2]	=>  Location: PIN_B7,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 8mA
-- dout[3]	=>  Location: PIN_A7,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 8mA
...
-- go	=>  Location: PIN_E8,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \u_cnt|count~0_combout\ = (!\u_cnt|count\(0) & !\rst~input_o\)
...
-- Equation(s):
-- \u_mae|timer_done~1_combout\ = (\rst~input_o\) # (!\u_mae|ep.debounce~q\)
...
-- Equation(s):
-- \u_mae|timer_done~3_combout\ = (\u_mae|timer_cnt\(0) & (\u_mae|timer_cnt\(1) & (!\u_mae|timer_done~1_combout\ & \u_mae|timer_done~2_combout\)))
...
PORT MAP (
	dataa => \u_mae|timer_cnt\(0),
	datab => \u_mae|timer_cnt\(1),
	datac => \u_mae|timer_done~1_combout\,
	datad => \u_mae|timer_done~2_combout\,
...
-- Equation(s):
-- \u_mae|ep~11_combout\ = (\u_mae|ep.wait_release~q\ & (\go~input_o\ & ((!\u_mae|ep.debounce~q\) # (!\u_mae|timer_done~q\))))
...
-- Equation(s):
-- \u_mae|ep~12_combout\ = (!\rst~input_o\ & ((\u_mae|ep.pulse~q\) # ((\u_mae|ep~11_combout\ & \u_mae|ep.idle~q\))))
...
PORT MAP (
	...
	datac => \u_mae|ep~11_combout\,
	datad => \u_mae|ep.idle~q\,
...
-- Equation(s):
-- \u_mae|ep~9_combout\ = (\u_mae|ep.wait_release~q\) # ((\u_mae|ep.debounce~q\) # ((!\u_mae|ep.pulse~q\ & !\u_mae|ep.idle~q\)))
...
-- Equation(s):
-- \u_mae|ep~8_combout\ = (!\rst~input_o\ & (\go~input_o\ & \u_mae|ep~7_combout\))
...
-- Equation(s):
-- \u_mae|ep~6_combout\ = (\u_mae|ep.debounce~q\ & (\u_mae|timer_done~q\ & (\go~input_o\ & !\rst~input_o\)))
...
-- Equation(s):
-- \u_cnt|count[0]~1_combout\ = (\rst~input_o\) # (\u_mae|ep.pulse~q\)
...
-- Equation(s):
-- \u_cnt|count~2_combout\ = (!\rst~input_o\ & (\u_cnt|count\(0) $ (\u_cnt|count\(1))))
...
-- Equation(s):
-- \u_cnt|count~3_combout\ = (!\rst~input_o\ & (\u_cnt|count\(2) $ (((\u_cnt|count\(0) & \u_cnt|count\(1))))))
...
-- Equation(s):
-- \u_cnt|count~4_combout\ = (!\rst~input_o\ & \u_cnt|Add0~0_combout\)
