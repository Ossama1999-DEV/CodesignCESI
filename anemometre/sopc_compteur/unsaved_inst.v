	unsaved u0 (
		...
		.in_freq_anemometre_export_conduit  (<connected-to-in_freq_anemometre_export_conduit>),  //   in_freq_anemometre_export.conduit
		.leds_external_connection_export    (<connected-to-leds_external_connection_export>),    //    leds_external_connection.export
		.pwm_out_writeresponsevalid_n       (<connected-to-pwm_out_writeresponsevalid_n>)        //                     pwm_out.writeresponsevalid_n
	);
