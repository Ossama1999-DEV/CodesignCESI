...
-- Design Ports Information
-- data_valid	=>  Location: PIN_R12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data_anemometre[0]	=>  Location: PIN_T15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data_anemometre[1]	=>  Location: PIN_N11,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data_anemometre[2]	=>  Location: PIN_N12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data_anemometre[3]	=>  Location: PIN_M10,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data_anemometre[4]	=>  Location: PIN_N16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data_anemometre[5]	=>  Location: PIN_R16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data_anemometre[6]	=>  Location: PIN_L13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data_anemometre[7]	=>  Location: PIN_L14,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- etat_dbg[0]	=>  Location: PIN_P11,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- etat_dbg[1]	=>  Location: PIN_T12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- etat_dbg[2]	=>  Location: PIN_P9,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- clk_50M	=>  Location: PIN_E1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- continu	=>  Location: PIN_R13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- start_stop	=>  Location: PIN_T13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- raz_n	=>  Location: PIN_T14,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- in_freq_anemometre	=>  Location: PIN_N15,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \Equal0~5_combout\ = ((tick_cnt(18)) # ((tick_cnt(16)) # (!tick_cnt(19)))) # (!tick_cnt(17))
...
-- Equation(s):
-- \Equal0~6_combout\ = (((!tick_cnt(23)) # (!tick_cnt(20))) # (!tick_cnt(22))) # (!tick_cnt(21))
...
-- Equation(s):
-- \Equal0~7_combout\ = (tick_cnt(24)) # ((tick_cnt(26)) # ((tick_cnt(27)) # (!tick_cnt(25))))
...
-- Equation(s):
-- \Equal0~8_combout\ = (tick_cnt(30)) # (tick_cnt(31))
...
-- Equation(s):
-- \Equal0~9_combout\ = (tick_cnt(29)) # ((tick_cnt(28)) # ((\Equal0~7_combout\) # (\Equal0~8_combout\)))
...
-- Equation(s):
-- \Equal0~1_combout\ = (tick_cnt(7)) # (((!tick_cnt(5)) # (!tick_cnt(4))) # (!tick_cnt(6)))
...
-- Equation(s):
-- \Equal0~0_combout\ = (((!tick_cnt(2)) # (!tick_cnt(0))) # (!tick_cnt(1))) # (!tick_cnt(3))
...
-- Equation(s):
-- \Equal0~3_combout\ = (((!tick_cnt(15)) # (!tick_cnt(12))) # (!tick_cnt(14))) # (!tick_cnt(13))
...
-- Equation(s):
-- \Equal0~2_combout\ = (tick_cnt(10)) # ((tick_cnt(11)) # ((tick_cnt(8)) # (tick_cnt(9))))
...
-- Equation(s):
-- \state~12_combout\ = (!\state.S_LATCH~q\ & (!\state.S_ARM~q\ & ((!\tick_end~q\) # (!\state.S_COUNT~q\))))
...
-- Equation(s):
-- \state~16_combout\ = (!\state.S_CLEAR~q\ & (!\state~11_combout\ & (\state~13_combout\ & \state~12_combout\)))
...
-- Equation(s):
-- \state~9_combout\ = (\raz_n~input_o\ & (\state.S_COUNT~q\ & \tick_end~q\))
...
-- Equation(s):
-- \Selector0~0_combout\ = (\data_valid_i~q\ & ((\state.S_LATCH~q\) # ((\state.S_ARM~q\) # (\state.S_COUNT~q\))))
...
PORT MAP (
	...
	datab => \state.S_ARM~q\,
	datac => \state.S_COUNT~q\,
	datad => \data_valid_i~q\,
	combout => \Selector0~0_combout\);

-- Location: LCCOMB_X39_Y5_N0
\Selector0~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \Selector0~1_combout\ = (\Selector0~0_combout\) # ((\state.S_VALID_HOLD~q\ & ((\continu~input_o\) # (\start_stop~input_o\))))
...
-- Equation(s):
-- \Selector15~0_combout\ = (\state.S_COUNT~q\ & ((\Add1~2_combout\) # ((\WideOr2~combout\ & live_cnt(1))))) # (!\state.S_COUNT~q\ & (\WideOr2~combout\ & (live_cnt(1))))
...
-- Equation(s):
-- \Selector14~0_combout\ = (\state.S_COUNT~q\ & ((\Add1~4_combout\) # ((live_cnt(2) & \WideOr2~combout\)))) # (!\state.S_COUNT~q\ & (((live_cnt(2) & \WideOr2~combout\))))
...
-- Equation(s):
-- \Selector10~0_combout\ = (\state.S_COUNT~q\ & ((\Add1~12_combout\) # ((\WideOr2~combout\ & live_cnt(6))))) # (!\state.S_COUNT~q\ & (\WideOr2~combout\ & (live_cnt(6))))
...
-- Equation(s):
-- \Selector9~0_combout\ = (\state.S_COUNT~q\ & ((\Add1~14_combout\) # ((live_cnt(7) & \WideOr2~combout\)))) # (!\state.S_COUNT~q\ & (((live_cnt(7) & \WideOr2~combout\))))
...
-- Equation(s):
-- \Selector8~0_combout\ = (\WideOr2~combout\ & ((live_cnt(8)) # ((\Add1~16_combout\ & \state.S_COUNT~q\)))) # (!\WideOr2~combout\ & (\Add1~16_combout\ & ((\state.S_COUNT~q\))))
...
-- Equation(s):
-- \Selector7~0_combout\ = (\WideOr2~combout\ & ((live_cnt(9)) # ((\Add1~18_combout\ & \state.S_COUNT~q\)))) # (!\WideOr2~combout\ & (\Add1~18_combout\ & ((\state.S_COUNT~q\))))
...
-- Equation(s):
-- \LessThan0~0_combout\ = (latched_cnt(11)) # ((latched_cnt(9)) # ((latched_cnt(10)) # (latched_cnt(8))))
...
-- pragma translate_on
PORT MAP (
	dataa => latched_cnt(11),
	datab => latched_cnt(9),
	datac => latched_cnt(10),
	datad => latched_cnt(8),
...
-- Equation(s):
-- \Selector4~0_combout\ = (\state.S_COUNT~q\ & ((\Add1~24_combout\) # ((\WideOr2~combout\ & live_cnt(12))))) # (!\state.S_COUNT~q\ & (\WideOr2~combout\ & (live_cnt(12))))
...
-- Equation(s):
-- \Selector3~0_combout\ = (\Add1~26_combout\ & ((\state.S_COUNT~q\) # ((\WideOr2~combout\ & live_cnt(13))))) # (!\Add1~26_combout\ & (\WideOr2~combout\ & (live_cnt(13))))
...
-- Equation(s):
-- \Selector2~0_combout\ = (\state.S_COUNT~q\ & ((\Add1~28_combout\) # ((\WideOr2~combout\ & live_cnt(14))))) # (!\state.S_COUNT~q\ & (\WideOr2~combout\ & (live_cnt(14))))
...
-- Equation(s):
-- \Selector1~0_combout\ = (\state.S_COUNT~q\ & ((\Add1~30_combout\) # ((\WideOr2~combout\ & live_cnt(15))))) # (!\state.S_COUNT~q\ & (\WideOr2~combout\ & (live_cnt(15))))
...
-- Equation(s):
-- \latched_cnt~6_combout\ = (\raz_n~input_o\ & live_cnt(12))
...
-- Equation(s):
-- \latched_cnt~8_combout\ = (live_cnt(14) & \raz_n~input_o\)
...
-- Equation(s):
-- \LessThan0~1_combout\ = (latched_cnt(15)) # ((latched_cnt(12)) # ((latched_cnt(14)) # (latched_cnt(13))))
...
-- pragma translate_on
PORT MAP (
	dataa => latched_cnt(15),
	datab => latched_cnt(12),
	datac => latched_cnt(14),
	datad => latched_cnt(13),
...
-- Equation(s):
-- \sat8~1_combout\ = (\LessThan0~0_combout\) # ((latched_cnt(1)) # (\LessThan0~1_combout\))
...
-- Equation(s):
-- \sat8~2_combout\ = (latched_cnt(2)) # ((\LessThan0~0_combout\) # (\LessThan0~1_combout\))
...
-- Equation(s):
-- \sat8~4_combout\ = (\LessThan0~0_combout\) # ((latched_cnt(4)) # (\LessThan0~1_combout\))
...
-- Equation(s):
-- \sat8~5_combout\ = (latched_cnt(5)) # ((\LessThan0~0_combout\) # (\LessThan0~1_combout\))
...
-- Equation(s):
-- \sat8~6_combout\ = (latched_cnt(6)) # ((\LessThan0~0_combout\) # (\LessThan0~1_combout\))
