...
-- Design Ports Information
-- dout[0]	=>  Location: PIN_L2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- dout[1]	=>  Location: PIN_L3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- dout[2]	=>  Location: PIN_N2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- dout[3]	=>  Location: PIN_N1,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- go	=>  Location: PIN_K5,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \u_mae|ep~10_combout\ = (\rst~input_o\ & ((!\u_mae|ep~9_combout\) # (!\go~input_o\)))
...
-- Equation(s):
-- \u_mae|timer_done~6_combout\ = (!\u_mae|timer_cnt\(13) & (\u_mae|timer_cnt\(19) & !\u_mae|timer_cnt\(10)))
...
-- pragma translate_on
PORT MAP (
	dataa => \u_mae|timer_cnt\(13),
	datac => \u_mae|timer_cnt\(19),
...
-- Equation(s):
-- \u_mae|timer_done~7_combout\ = (\u_mae|timer_done~5_combout\ & (\u_mae|timer_cnt\(18) & (\u_mae|timer_done~6_combout\ & \u_mae|timer_done~4_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \u_mae|timer_done~5_combout\,
	datab => \u_mae|timer_cnt\(18),
	datac => \u_mae|timer_done~6_combout\,
...
-- Equation(s):
-- \u_mae|ep~6_combout\ = (\u_mae|timer_done~q\ & (\rst~input_o\ & (\u_mae|ep.debounce~q\ & !\go~input_o\)))
...
-- Equation(s):
-- \u_cnt|Add0~0_combout\ = \u_cnt|count\(3) $ (((\u_cnt|count\(1) & (\u_cnt|count\(0) & \u_cnt|count\(2)))))
